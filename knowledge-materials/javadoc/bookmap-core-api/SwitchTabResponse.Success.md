---
source_file: SwitchTabResponse.Success.html
package: velox.api.layer1.messages.tab
classes: SwitchTabResponse.Success
methods: of, match, toString
---

# SwitchTabResponse.Success
...
```java
public static SwitchTabResponse.Success of()
```
